...
@section('content')
    <div class="d-flex-between">
        <h1 class="admin-title" style="margin-bottom: 0;">Editar Categoria: {{ $category->name }}</h1>
        ...
        <form action="{{ route('admin.categories.update', $category->id) }}" method="POST">
            ...
            <div class="grid-2 form-group">
                ...
                <div>
                    ...
                    <input type="text" name="macro_theme" value="{{ old('macro_theme', $category->macro_theme) }}" class="form-control">
                </div>
            </div>
